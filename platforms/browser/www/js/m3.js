        ...
        function start_puzzle(x){
            ...
            $('#source_image').snapPuzzle({
                ...
                onComplete: function(){
                    ...
                    setTimeout(function(){ window.location.replace("m3_1.html"); }, 800);
                    
                    if (typeof(Storage) === "undefined") {
						console.log("Sorry! No Web Storage support...");
					} else {
						endTime = endClock();
						if (typeof(localStorage.m1) === "undefined") {
							localStorage.m1 = endTime;
							localStorage.p1 = 2;
						} else {
							if((localStorage.p1 < 3) && (endTime < localStorage.m1)){
								localStorage.p1++;
							}
							localStorage.m1 = endTime;
						}
        ...
        $(function(){
			...
			if (typeof(Storage) === "undefined") {
				...
				if (typeof(localStorage.p1) === "undefined") {
					start_puzzle(2);
				} else {
					start_puzzle(localStorage.p1);
				}
			}   
